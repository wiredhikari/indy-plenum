...
from plenum.server.plugin.did_plugin.request_handlers.create_network_did_handler import CreateNetworkDIDHandler
...
def integrate_plugin_in_node(node):
    ...
    node.write_manager.register_req_handler(CreateNetworkDIDHandler(node.db_manager, did_dict))
